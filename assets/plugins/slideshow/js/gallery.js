$( function() {
    ...
    var trafficSound = new buzz.sound( baseUrl+'slideshow/sounds/traffic' ),
        clickSound = new buzz.sound( baseUrl+'slideshow/sounds/click' ),
        focusSound = new buzz.sound( baseUrl+'slideshow/sounds/focus' ),
        rewindSound = new buzz.sound( baseUrl+'slideshow/sounds/rewind' ),

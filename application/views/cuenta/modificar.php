...
<form id="frmCuenta" class="form-horizontal" action="#" style="border-radius: 0px;" method="post">
	<div class="form-group">
		...
		<div class="col-sm-6">
			...
			<script> $("#drpdTipoCuenta").val('<?php echo $cuenta->getIdTipoCuenta();?>');</script>
		</div>
	</div>
	<div class="form-group">
		<label for="txtNombre" class="col-sm-3 control-label"><?php echo Texto::idioma("Nombre");?></label>
		<div class="col-sm-6">
			<input id="txtNombre" class="required form-control" type="text" name="txtNombre" placeholder="<?php echo Texto::idioma("Nombre");?>" maxlength="200"  value="<?php echo $cuenta->getDescripcion();?>"/>
		</div>
	</div>
	<div class="form-group">
		<div class="col-sm-offset-2 col-sm-10">
			<input readonly="readonly" type="hidden" id="txtCuenta" name="txtCuenta" class="ancho500" value="<?php echo Encryption::encode($cuenta->getIdCuenta());?>"/>

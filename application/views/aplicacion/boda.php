<div class="panel panel-default panel-post">
	<div class="panel-body">
		<div class="row no-margin">
			<div class="col-lg-12 no-padding">
				<section class="bg-primary subtitle">
					<h2><?php echo Texto::idioma("Por_Que_Casarse_Contigo");?></h2>
				</section>	
			</div>
		</div>
		...
		<div data-bind="visible:!conResultado()" class="post-thumbnail no-margin">
			<img src="<?php echo IMAGE."boda/default.jpg";?>" data-bind="visible:!conResultado()">
	...
	<div class="panel-footer">
		<ul class="post-action">
			<li><a href="#" class=""><i class="fa fa-heart"></i> <span data-bind="html:boda.like"></span></a></li>
...
<script src="<?php echo VIEWMODEL;?>boda.min.js"></script>
<script type="text/javascript">
	$(document).ready(function() {
		ko.applyBindings(boda, $("#divVista").get(0));
		boda.id("<?php echo $id;?>");
		boda.obtenerDetalle();
    });
</script>
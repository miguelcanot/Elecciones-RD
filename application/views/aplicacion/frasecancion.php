<div class="panel panel-default panel-post">
	<div class="panel-body">
		<div class="row no-margin">
			<div class="col-lg-12 no-padding">
				<section class="bg-primary subtitle">
					<h2><?php echo Texto::idioma("Cual_Es_Tu_Frase_Cancion");?></h2>
				</section>	
			</div>
		</div>
		...
		<div data-bind="visible:!conResultado()">
			<img src="<?php echo IMAGE."frase/default.jpg";?>" data-bind="visible:!conResultado()">
	...
	<div class="panel-footer">
		<ul class="post-action">
			<li><a href="#" class=""><i class="fa fa-heart"></i> <span data-bind="html:frase.like"></span></a></li>
...
<script src="<?php echo VIEWMODEL;?>frase.js"></script>

<script type="text/javascript">
	$(document).ready(function() {
		$("#frmMinisterio").validate();
	});	
</script>
		<form id="frmMinisterio" class="form-horizontal" action="#" style="border-radius: 0px;" method="post" enctype="multipart/form-data">
			<div class="form-group">
				<label for="txtNombre" class="col-sm-3 control-label"><?php echo Texto::idioma("Nombre");?></label>
				<div class="col-sm-6">
					<input id="txtNombre" class="required form-control" type="text" name="txtNombre" placeholder="<?php echo Texto::idioma("Nombre");?>" autofocus/>
				</div>
			</div>
			<div class="form-group">
				<label class="col-sm-3 control-label" for="txtDescripcion"><?php echo Texto::idioma("Descripcion", IDIOMA);?></label>
				<div class="col-sm-6">
					<input id="txtDescripcion" class="form-control" type="text" name="txtDescripcion" placeholder="<?php echo Texto::idioma("Descripcion");?>" maxlength="2000" />
				</div>
			</div>
			<div class="form-group">
				<label class="col-sm-3 control-label" for="txtIcono"><?php echo Texto::idioma("Icono", IDIOMA);?></label>
				<div class="col-sm-6">
					<input id="txtIcono" class="form-control" type="text" name="txtIcono" placeholder="<?php echo Texto::idioma("Icono");?>" maxlength="50" />
				</div>
			</div>
			<div class="form-group">
			...
			<div class="form-group">
				...
				<div class="col-sm-6">
					<input id="txtComentario" class="form-control" type="text" name="txtComentario" placeholder="<?php echo Texto::idioma("Comentario");?>" maxlength="500"/>
				</div>
			</div>
			...
			<div class="form-group">
				<div class="col-sm-offset-2 col-sm-10">
					...
					<a href="<?php echo base_url()."ministerio";?>"><button id="btnCancelar" type="button" class="btn btn-default"><?php echo Texto::idioma("Cancelar", IDIOMA);?></button></a>
				</div>
			</div>
		</form>
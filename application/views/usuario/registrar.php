...
<form id="frmUsuario" class="form-horizontal" action="#" style="border-radius: 0px;" method="post">
	...
	<div class="form-group">
		<label class="col-sm-3 control-label" for="txtClave"><?php echo Texto::idioma("Contrasena")." (".Texto::idioma("Contrasena_Parametro").")";?></label>
		<div class="col-sm-6">
			<input type="password" id="txtClave" name="txtClave" class="required ancho300 form-control" placeholder="<?php echo Texto::idioma("Contrasena");?>" minlength="1" maxlength="100">
		</div>
	</div>
	<div class="form-group">
		<label class="col-sm-3 control-label" for="txtConfirmarClave"><?php echo Texto::idioma("Confirmar_Contrasena", IDIOMA);?>
		</label>
		<div class="col-sm-6">
			<input type="password" id="txtConfirmarClave" name="txtConfirmarClave" class="required ancho300 form-control" equalto="#txtClave" placeholder="<?php echo Texto::idioma("Confirmar_Contrasena");?>" minlength="1" maxlength="100">
		</div>
	</div>
	<div class="form-group">
		<label class="col-sm-3 control-label" for="drpdRol"><?php echo Texto::idioma("Rol", IDIOMA);?>
		</label>
		<div class="col-sm-6">
